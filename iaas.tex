...
\node<1> at (2,0) [absolute,overlay] {\pgfimage[width=\textwidth]{images/Instance_Ingredients.png}};
\node<2> at (2,0) [absolute,overlay] {\pgfimage[width=\textwidth]{images/Instance_Links.png}};
\end{tikzpicture}
\end{columns}
\end{frame}
